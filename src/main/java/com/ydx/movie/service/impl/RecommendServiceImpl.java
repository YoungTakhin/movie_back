...
public class RecommendServiceImpl implements RecommendService {
    ...
    public String recommendForUser(int userId) {
        ...
        for (String tmdbid : jsonObject.keySet()) {
            recommend.addRecommend(movieService.findMovieByTmdbid(Integer.parseInt(tmdbid)),
                    jsonObject.getFloat(tmdbid));
        }
        // System.out.println(recommend.getRecommendList().size());
